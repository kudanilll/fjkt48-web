...
export default function MemberCard(props: MemberType) {
  ...
  return (
    <Card
      ...
      actions={[
        <Link key="instagram" href={props.instagram} target="_blank">
          <FaInstagram size={24} className="mx-5 md:mx-9" />
        </Link>,
        <Link key="tiktok" href={props.tiktok} target="_blank">
          <FaTiktok size={24} className="mx-5 md:mx-9" />
        </Link>,
        <Link key="twitter" href={props.twitter} target="_blank">
          <FaXTwitter size={24} className="mx-5 md:mx-9" />
        </Link>,
      ]}
      hoverable>
