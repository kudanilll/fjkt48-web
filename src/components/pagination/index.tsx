    ...
    <div className="flex items-center justify-center py-4 lg:px-0 sm:px-6 px-4">
      <div className="lg:w-3/5 w-full flex items-center justify-between">
        <div className="flex items-center pt-3 text-gray-800 cursor-pointer">
          <Image onClick={prev} src={leftIcon} alt="prev" width={24} height={24}/>
          <p onClick={prev} className="text-sm ml-1 font-medium leading-none">Sebelumnya</p>
        </div>
        ...
        <div className="flex items-center pt-3 text-gray-800 cursor-pointer">
          <p onClick={next} className="text-sm font-medium text-center whitespace-nowrap mr-1">Selanjutnya</p>
          <Image onClick={next} src={rightIcon} alt="next" width={24} height={24}/>
        </div>
      </div>
    </div>
  );
